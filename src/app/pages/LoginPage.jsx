...
const LoginPage = () => {
    ...
    return (
        <div className="flex flex-col justify-center items-center">
            <h2 className='dark:text-white text-3xl font-bold mb-11'>Login in to your account on <span className='text-pink-500'>READ.ME</span></h2>
        ...
        <p className='mt-5'>Do not have an account? <Link className='text-pink-500' to="/registration">Register</Link></p>
      </div>
    );
}
